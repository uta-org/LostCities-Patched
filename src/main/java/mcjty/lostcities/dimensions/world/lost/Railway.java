...
public class Railway {
     ...
     */
    private static RailChunkInfo getRailChunkTypeInternal(int chunkX, int chunkZ, ICommonGeneratorProvider provider) {
    ...
    private static RailChunkInfo getStationType(int chunkX, int chunkZ, ICommonGeneratorProvider provider, LostCityProfile profile, float r, int rails, String part) {
    ...
    public static RailChunkInfo getRailChunkType(int chunkX, int chunkZ, ICommonGeneratorProvider provider, LostCityProfile profile) {
    ...
    private static RailChunkInfo testAdjacentRailChunk(float r, RailChunkInfo adjacent, RailDirection direction, int chunkX, int chunkZ, ICommonGeneratorProvider provider, LostCityProfile profile) {
