...
public class LostCitiesTerrainGenerator extends NormalTerrainGenerator {
    ...
    public void generate(int chunkX, int chunkZ, ChunkPrimer primer, boolean forceCityChunk) {
        ...
        if (info.isCity || (info.outsideChunk && info.hasBuilding) || forceCityChunk) {
...
//        }
    ...
    private void generateStreet(BuildingInfo info, ICommonHeightmap heightmap, Random rand) {
        ...
        switch (info.profile.LANDSCAPE_TYPE) {
            ...
            case SPACE: {
                ...
                if (adjacent.isCity) {
                    ...
                    ICommonHeightmap adjacentHeightmap = provider.getHeightmap(adjacent.chunkX, adjacent.chunkZ);
...
//        char defaultStreet = info.profile.isFloating() ? street2 : streetBase;
    ...
    private void generateBuilding(BuildingInfo info, ICommonHeightmap heightmap) {
